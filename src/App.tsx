...
// Typography - Style 21st
const F = {
  display: "'Cormorant Garamond', Georgia, serif",
  ui: "'Inter', -apple-system, sans-serif",
};

// Colors - Loire Crépuscule Theme (plus clair/chaud)
const C = {
  bg: '#121418',           // Bleu nuit profond (pas noir)
  bgElevated: '#1A1E24',   // Bleu nuit plus clair
  text: '#F5F0EB',         // Crème chaud
  textMuted: 'rgba(245,240,235,0.55)',
  accent: '#8B5A6B',       // Rose/vieux bordeaux (plus doux)
  accentLight: '#D4A574',  // Or sable
  gold: '#B8956B',         // Or terreux
};
...
const featuredWines = [
  {
    name: 'Ma Cuvée DOR',
    cuvee: 'Sables & graviers',
    appellation: 'AOP Saint-Nicolas-de-Bourgueil',
    price: '10,80 €',
    vintage: 2023,
    image: 'https://assets.evolusite.fr/3/Ma_Cuvée_d_Or_PmEbKNgI6.jpg',
    badge: 'Accessible',
    poem: 'Fruits rouges éclatants, légèreté sableuse.',
  },
  {
    name: 'Cuvée Estelle',
    cuvee: 'Sablonneux · fruité',
    appellation: 'AOP Saint-Nicolas-de-Bourgueil',
    price: '11,30 €',
    vintage: 2024,
    image: 'https://assets.evolusite.fr/3/Estelle-removebg-preview_AgfXXrabx.png',
    poem: "Fruité, frais, équilibré — l'âme du Saint-Nicolas.",
  },
  {
    name: 'Les Malgagnes',
    cuvee: 'Argilo-siliceux',
    appellation: 'AOP Saint-Nicolas-de-Bourgueil',
    price: '14,00 €',
    vintage: 2020,
    image: 'https://assets.evolusite.fr/3/n6uskwu0wt7roib1nj6qns_j1c2qvoS0.png',
    badge: 'Coup de cœur',
    poem: "Fin, complexe, élégant — l'ADN de la famille.",
  },
  {
    name: 'Les Tuffes',
    cuvee: 'Argilo-calcaire',
    appellation: 'AOP Bourgueil',
    price: '11,30 €',
    vintage: 2021,
    image: 'https://assets.evolusite.fr/3/nurx6fwvk2rpgq93bft9s7q_HgtSjCUlH.png',
    poem: 'Caractère viril, rondeur sur le tuffeau.',
  },
  {
    name: 'Caudalies',
    cuvee: '12–18 mois en fûts',
    appellation: 'AOP Bourgueil',
    price: '18,00 €',
    vintage: 2021,
    image: 'https://assets.evolusite.fr/3/Caudalies__2__Zn9svhsus.jpg',
    badge: 'Prestige',
    poem: 'Vendange manuelle, élevage en barriques.',
  },
];
...
const vignerons = [
  {
    name: 'Estelle Cognard',
    role: 'Vigneronne',
    generation: '2ème génération',
    image: 'https://assets.evolusite.fr/ik-seo/3/estelle-et-rodolphe-maison-cognard.JPG',
  },
  {
    name: 'Rodolphe Cognard',
    role: 'Vinificateur',
    generation: '2ème génération',
    image: 'https://assets.evolusite.fr/ik-seo/3/estelle-et-rodolphe-maison-cognard.JPG',
  },
  {
    name: 'Flavien Cognard',
    role: 'Vigneron',
...
const faqItems = [
  {
    question: 'Où puis-je acheter vos vins ?',
    answer: 'Vous pouvez acheter directement au caveau de dégustation à Saint-Nicolas-de-Bourgueil, sur notre boutique en ligne, ou nous retrouver dans les salons de vin en France.'
  },
  {
    question: 'Proposez-vous des visites de cave ?',
    answer: 'Oui, nous proposons des visites guidées du vignoble et de la cave sur rendez-vous. La dégustation est bien sûr incluse ! Contactez-nous au 02 47 97 76 88.'
  },
  {
    question: 'Quelle est la température idéale de service ?',
    answer: 'Nos vins rouges se servent entre 14°C et 18°C selon les cuvées. Les plus légers (Ma Cuvée DOR, Estelle) vers 14-16°C, les plus structurés (Caudalies) vers 16-18°C.'
  },
  {
    question: 'Livrez-vous à l\'international ?',
    answer: 'Pour le moment, nous livrons uniquement en France métropolitaine. Pour les expéditions à l\'étranger, contactez-nous directement pour étudier les possibilités.'
  },
  {
    question: 'Quel est le potentiel de garde de vos vins ?',
    answer: 'Il varie selon les cuvées : de 3-5 ans pour les plus accessibles (Ma Cuvée DOR) jusqu\'à 10-15 ans pour les cuvées prestige élevées en barriques (Caudalies).'
  }
];
...
function QuizModal({ onClose }: { onClose: () => void }) {
  ...
  const recommended = [...featuredWines]
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4"
      ...
      <div ref={panelRef} className="relative w-full max-w-xl rounded-2xl overflow-hidden"
        style={{ background: C.bgElevated, border: '1px solid rgba(255,255,255,0.1)' }}>
        <button 
        ...
        {!done ? (
          <div className="p-10 md:p-12">
            <div className="flex gap-2 mb-10">
              {QUIZ_QUESTIONS.map((_, i) => (
                <div key={i} className="h-px flex-1"
                  style={{ background: i <= step ? C.accent : 'rgba(255,255,255,0.1)' }} />
              ))}
            </div>
            ...
            <h3 className="text-3xl md:text-4xl font-light mb-10" style={{ fontFamily: F.display }}>
              {QUIZ_QUESTIONS[step].question}
            </h3>
            <div className="grid grid-cols-2 gap-4">
              {QUIZ_QUESTIONS[step].options.map((opt, idx) => (
                <Magnetic key={idx} strength={0.1}>
                  <button onClick={() => pick(opt.scores)}
                    className="p-6 rounded-xl text-left transition-all duration-300 hover:bg-white/5 group"
                    style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' }}>
                    <div className="text-3xl mb-3 group-hover:scale-110 transition-transform">{opt.icon}</div>
                    <p className="text-sm text-white/80 font-medium" style={{ fontFamily: F.ui }}>{opt.label}</p>
                  </button>
                </Magnetic>
              ))}
            </div>
          ...
          <div className="p-10 md:p-12">
            ...
            <h3 className="text-3xl font-light mb-8" style={{ fontFamily: F.display }}>Notre recommandation</h3>
              ...
              {recommended.map((wine: any, i: number) => (
                <div key={i} className="flex items-center gap-4 p-4 rounded-xl"
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-light text-lg" style={{ fontFamily: F.display }}>{wine.name}</p>
                    <p className="text-xs text-white/40">{wine.cuvee}</p>
                  </div>
                  <p className="text-xl font-light" style={{ fontFamily: F.display, color: C.accentLight }}>{wine.price}</p>
                </div>
              ))}
            </div>
            <a href="https://vins-stnicolas-bourgueil-cognard.fr/nos-cuvees" target="_blank" rel="noopener"
              onClick={playClick}
              className="block w-full py-4 rounded-xl text-sm tracking-[0.15em] uppercase text-center text-white"
              style={{ fontFamily: F.ui, background: C.accent }}>
              Commander en ligne
            </a>
          </div>
        )}
  ...
  return (
    <SmoothScroll>
      <>
        ...
        <button onClick={() => { playClick(); setQuizOpen(true); }}
          onMouseEnter={playHover}
          className="fixed bottom-8 right-8 z-[280] w-16 h-16 rounded-full flex items-center justify-center group transition-transform hover:scale-110"
          style={{ background: C.accent, boxShadow: '0 10px 40px -10px rgba(122,26,26,0.6)' }}>
          <span className="text-2xl">🍷</span>
          <span className="absolute -top-12 right-0 bg-white text-black text-xs px-4 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity"
        ...
        <div ref={mainRef} className="min-h-screen" style={{ background: C.bg, color: C.text, fontFamily: F.ui }}>
          ...
          <nav className="fixed top-0 left-0 w-full z-50 px-8 md:px-16 py-6 flex justify-between items-center mix-blend-difference">
            ...
            <div className="hidden md:flex items-center gap-12">
              {['Histoire', 'Vins', 'Vignerons', 'Contact'].map((item) => (
                <a 
                  ...
                  onMouseEnter={playHover}
                  onClick={playClick}
                  className="text-xs tracking-[0.15em] uppercase text-white/60 hover:text-white transition-colors relative group"
                  style={{ fontFamily: F.ui }}>
                  {item}
            ...
            <Magnetic strength={0.2}>
              <a 
                ...
                onMouseEnter={playHover}
                onClick={playClick}
                className="hidden md:flex items-center gap-2 text-xs tracking-[0.1em] uppercase px-6 py-3 rounded-full border border-white/20 hover:bg-white hover:text-black transition-all"
                style={{ fontFamily: F.ui }}>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                <div>
                  ...
                  <p className="reveal-up text-xs tracking-[0.3em] uppercase mb-6" style={{ color: C.accentLight }}>
                    Notre Histoire
                  </p>
                  <h2 className="text-4xl md:text-6xl font-light leading-[1.1] mb-8" style={{ fontFamily: F.display }}>
                    <EnhancedTextReveal splitBy="words">
                      50 ans de passion familiale
                    </EnhancedTextReveal>
                  </h2>
                  <p className="reveal-up text-white/50 text-lg leading-relaxed mb-8">
                    En 1973, Lydie et Max Cognard plantent leur premier hectare de Cabernet Franc 
                    à Saint-Nicolas-de-Bourgueil. Ce cépage unique, ces terres de tuffeau, 
                    deviendront l'héritage d'une saga familiale.
                  </p>
                  <div className="reveal-up grid grid-cols-3 gap-8">
                    {[
                      { num: '50+', label: 'Années' },
                      { num: '3', label: 'Générations' },
                      { num: '15', label: 'Hectares' },
                    ].map((stat) => (
                      <div key={stat.label}>
                        <p className="text-3xl md:text-4xl font-light mb-1" style={{ fontFamily: F.display, color: C.accentLight }}>
                          {stat.num}
                        </p>
                ...
                <div className="reveal-up">
                  <ParallaxImage
                    src="https://assets.evolusite.fr/ik-seo/3/xwgsun72vacozjglyp9yw_gqH-6nzR1/estelle-et-rodolphe-maison-cognard.JPG"
                    alt="Famille Cognard"
              ...
              {/* Timeline */}
              <div className="mt-32">
                <div className="reveal-line w-full h-px mb-16" style={{ background: 'rgba(255,255,255,0.1)' }} />
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                  {timeline.map((item, i) => (
                    <div key={i} className="reveal-up">
                      <p className="text-sm tracking-[0.2em] uppercase mb-2" style={{ color: C.accentLight, fontFamily: F.ui }}>
                        {item.year}
                      </p>
          ...
          <section id="vins" className="py-32 md:py-48 px-6 md:px-16" style={{ background: C.bgElevated }}>
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-20">
                <div>
                  <div className="reveal-line w-16 h-px mb-8" style={{ background: C.accent }} />
                  <p className="reveal-up text-xs tracking-[0.3em] uppercase mb-4" style={{ color: C.accentLight }}>
                    Nos Cuvées
                  </p>
                ...
                <p className="reveal-up text-white/40 max-w-sm mt-6 md:mt-0">
                  Cinq cuvées, cinq expressions du même cépage sur des terroirs différents.
                </p>
              </div>
                  ...
                  <div key={i} className="reveal-up group">
                    <div className="relative aspect-[3/4] mb-6 overflow-hidden rounded-2xl">
                      ...
                      <div className="absolute bottom-6 left-6">
                        <p className="text-xs tracking-[0.2em] uppercase" style={{ color: C.accentLight, fontFamily: F.ui }}>
                          {v.generation}
                        </p>
                      </div>
                    </div>
                    <h3 className="text-2xl font-light mb-1" style={{ fontFamily: F.display }}>{v.name}</h3>
                    <p className="text-sm text-white/40" style={{ fontFamily: F.ui }}>{v.role}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="py-32 md:py-48 px-6 md:px-16" style={{ background: C.bgElevated }}>
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-16">
                <p className="text-xs tracking-[0.3em] uppercase mb-4" style={{ color: C.accentLight }}>
                  FAQ
                </p>
          ...
          <section className="py-32 md:py-48 px-6 md:px-16 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <p className="reveal-up text-white/50 text-lg mb-12 max-w-xl mx-auto">
                Caveau de dégustation ouvert toute la semaine. 
                Découvrez nos vins au cœur du vignoble.
              </p>
              <div className="reveal-up flex flex-col sm:flex-row gap-4 justify-center">
                <Magnetic strength={0.15}>
                  <a 
                    ...
                    onMouseEnter={playHover}
                    onClick={playClick}
                    className="inline-flex items-center gap-3 px-8 py-4 rounded-full text-sm tracking-[0.15em] uppercase"
                    style={{ fontFamily: F.ui, background: C.accent }}>
                ...
                <Magnetic strength={0.15}>
                  <a 
                    href="https://www.instagram.com/vinscognard/" 
                    target="_blank" 
                    rel="noopener"
                    onMouseEnter={playHover}
                    onClick={playClick}
                    className="inline-flex items-center gap-3 px-8 py-4 rounded-full text-sm tracking-[0.15em] uppercase border border-white/20 hover:bg-white/10 transition-all"
                    style={{ fontFamily: F.ui }}>
                    Instagram
                  </a>
                </Magnetic>
          ...
          {/* Footer */}
          <footer id="contact" className="py-20 px-6 md:px-16 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
            <div className="max-w-7xl mx-auto">
              <div className="grid md:grid-cols-4 gap-12 mb-16">
                <div className="md:col-span-2">
                  <p className="text-3xl font-light mb-4" style={{ fontFamily: F.display }}>Famille Cognard</p>
                  <p className="text-white/40 text-sm leading-relaxed max-w-sm">
                    1379 route du Carroi Taveau<br />
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <a 
                      href="https://www.facebook.com/vinscognard/" 
                      target="_blank" 
                      rel="noopener"
                      onMouseEnter={playHover}
                      onClick={playClick}
              ...
              <div className="pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4"
                ...
                <p className="text-xs text-white/25 tracking-widest" style={{ fontFamily: F.ui }}>
                  © 2026 Famille Cognard · Domaine viticole depuis 1973
                </p>
